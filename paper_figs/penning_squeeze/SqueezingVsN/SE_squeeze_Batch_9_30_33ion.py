...
show_dynamics = False
save_dynamics = False
img_name = "spinNoise_9_30_N33"
legend = True
raw = False

files_to_use = [15,14,11]
J1k = 2043.0    
Ncal = 1.0
ODF_seq = 4 # use 2 for a simple sequence, 4 for Walsh, set up to get the detunings correct
...
base_path = os.getcwd()
base_path = os.path.normpath("/Users/jgb/Data/20150930/Load331/squeeze/")
